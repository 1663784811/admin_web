        ...
        <template #item="{ element, index }">
          <div class="columnsRow">
            <div class="row">
              ...
              <div class="rowItem">
                <Select v-model="element.type" size="small" placeholder="列类型" clearable style="width:110px" @on-change="changeType(element)">
              ...
              <div class="rowItem">
                <Select v-model="element.sort" size="small" clearable style="width:110px" @on-change="changeType(element)">
